...
export const applyThemeColorFromStorage = (): void => {
  // Get theme color from localStorage or use default dark-pastel green
  const themeColor = localStorage.getItem('themeColor') || '#009b77';

  // Extract RGB components
  let r = 0, g = 155, b = 119; // Default dark-pastel green
